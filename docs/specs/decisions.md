...
| What the inspector shows: every component, named through the type registry | [ui.md §6](./ui.md) |
...
| Inspector | **every component on the entity**, named through the type registry, sorted by name ([ui.md §6](./ui.md)) |
